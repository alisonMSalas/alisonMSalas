<img src="https://capsule-render.vercel.app/api?type=waving&color=0d0b14&height=200&section=header&text=Alison%20Salas&fontSize=52&fontColor=f5a8cb&fontAlignY=38&desc=Full-Stack%20Developer%20%E2%80%94%20Ambato,%20Ecuador&descColor=c9a8e8&descSize=15&descAlignY=58&animation=fadeIn" width="100%" />

<div align="center">

Desarrolladora **Full-Stack** con experiencia en aplicaciones empresariales completas.<br/>
Actualmente en pasantías en **CiAuto** — gestión de RRHH y automatización de procesos financieros.
...
Desarrollo soluciones web completas — del diseño de interfaz a la base de datos. Me especializo en aplicaciones empresariales con arquitecturas limpias, autenticación robusta y APIs bien documentadas. Actualmente en pasantías en **CiAuto**, donde construyo un sistema de gestión de RRHH y una plataforma de automatización de procesos financieros con n8n.

Ingeniera de Software egresada de la **Universidad Técnica de Ambato** · Castellano nativo · Inglés B1
...
![React](https://img.shields.io/badge/React_19-0d1117?style=flat-square&logo=react&logoColor=61DAFB)
...
![Karma](https://img.shields.io/badge/Karma-429E4A?style=flat-square&logoColor=white)
...
Sistema full-stack para la gestión de recursos humanos con roles diferenciados (Admin, Empleado, Firmante, Oficial). Módulos de empleados y accesos, certificados laborales con generación .docx, control de vacaciones, caja de ahorro y reportes Excel. Autenticación JWT con sesión persistente y API documentada con Swagger.
...
Plataforma de automatización de procesos financieros y operativos para una empresa automotriz: Cuentas por Cobrar con aging de cartera, Riesgo de Clientes con matriz configurable, catálogo de vehículos con importación XML/Excel y procesamiento de estados bancarios. Reportes Excel (Apache POI) y PDF (iText7). Flujos n8n para envío masivo de emails y clasificación de transacciones.
...
Plataforma para la gestión de seguros con pruebas automatizadas. Gestión de componentes, servicios y validaciones con Angular, testing unitario con Karma y Jasmine.
...
App para gestionar finanzas personales: metas de ahorro, control de gastos, automatización de pagos y reportes visuales interactivos. Foco en experiencia de usuario y usabilidad.
...
Sistema implementado activamente en la Universidad Técnica de Ambato para la gestión de reservas de aulas y laboratorios. Usado por la facultad de Ingeniería de Software.
...
Aplicación móvil híbrida para foros académicos: publicaciones, comentarios, gestión de perfil y sistema de moderación con "strikes" por contenido inapropiado.
...
Sistema CRUD para la administración de salas, citas y clientes de un spa. Foco en la eficiencia de los flujos administrativos y la gestión de agenda.
...
Sistema completo para la gestión administrativa y clínica de centros de salud. Automatización de procesos de registro, consultas y seguimiento de pacientes.

![Java](https://img.shields.io/badge/Java-F89820?style=flat-square&logo=openjdk&logoColor=white)
![MySQL](https://img.shields.io/badge/MySQL-00758F?style=flat-square&logo=mysql&logoColor=white)
![Swing](https://img.shields.io/badge/Swing-007396?style=flat-square&logoColor=white)
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0d0b14&height=100&section=footer" width="100%" />
